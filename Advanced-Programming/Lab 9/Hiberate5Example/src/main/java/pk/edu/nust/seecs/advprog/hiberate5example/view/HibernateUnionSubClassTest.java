...
import pk.edu.nust.seecs.advprog.hiberate5example.bo.impl.ResourceBoImpl;
import pk.edu.nust.seecs.advprog.hiberate5example.bo.impl.TaskBoImpl;
...
public class HibernateUnionSubClassTest {
    ...
    private TaskBo taskHandler=new TaskBoImpl();
    private ResourcesBo resourceHandler=new ResourceBoImpl();
    ...
    public void doAll(){
        ...
        taskHandler.addTask(1, "Analyze", "Start");
        taskHandler.addTask(1, "Analyze", "End");
