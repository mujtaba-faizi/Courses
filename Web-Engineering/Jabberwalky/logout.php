    		...
    		<div class="row">
    			...
    			<div class="collapse navbar-collapse clearfix" id="bs-example-navbar-collapse-1" role="navigation">
    				<ul class="nav navbar-nav navbar-right">
    					...
    					<li><a class="page-scroll" href="Sign-up.html" >Sign up</a></li>
    					<li><a class="page-scroll"  href="signin.php" >Sign in</a></li>
    				</ul>
    			</div>
        ...
        <div class="container">
            <div class="hero-content text-center">
                <div class="hero-text" >
                    ...
                    <button class="btn btn-primary page-scroll" ><a href="sign-up.html "> Get in Touch</a></button>
                </div><!--/ Hero text end -->
